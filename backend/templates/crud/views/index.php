...
<div class="<?php echo Inflector::camel2id(StringHelper::basename($generator->modelClass)) ?>-index">
    ...
    <?php echo "<?php echo " ?>Html::a(<?php echo $generator->generateString('Create ' . Inflector::camel2words(StringHelper::basename($generator->modelClass))) ?>, ['create'], ['class' => 'btn btn-success float-right']) ?>
...
?>
            [
                ...
                'urlCreator' => function ($action, <?php echo $modelClass ?> $model, $key, $index, $column) {
                    return Url::toRoute([$action, <?php echo $generator->generateUrlParams() ?>]);
                 }
            ],
        ],
    ]); ?>
<?php else: ?>
    <?php echo "<?php echo " ?>ListView::widget([
        ...
        'itemView' => function ($model, $key, $index, $widget) {
            return Html::a(Html::encode($model-><?php echo $generator->getNameAttribute() ?>), ['view', <?php echo $generator->generateUrlParams() ?>]);
        },
    ]) ?>
<?php endif; ?>
